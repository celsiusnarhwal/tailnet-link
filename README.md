...
| `hostname`              | A fixed [machine name](https://tailscale.com/kb/1098/machine-names). By default, a name will be derived from the runner's OS, architecture, and a UUID.          | No                                                        |
